...
export const ProductListOnCart = () => {
  ...
  return (
    ...
    >
      <Card className="w-5xl bg-white/80 backdrop-blur-2xl border border-green-200/50 shadow-2xl shadow-green-500/20 rounded-3xl overflow-hidden">
        <CardHeader className="relative bg-gradient-to-br from-green-500 to-green-600 rounded-b-3xl pb-8 pt-12">
          <div className="flex items-center justify-center gap-4">
            <div className="relative">
              <div className="absolute inset-0 bg-white/20 rounded-full scale-125 blur-md"></div>
